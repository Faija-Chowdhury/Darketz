...
Route::post('/see', [ShopController::class, 'fix']);
...
Route::post('/post', [CartController::class, 'post']);
...
Route::get('/user/change', [UserController::class, 'show'])->name('user.password.change');
Route::get('/user/change/profile', [UserController::class, 'showProfile'])->name('user.profile');
Route::post('/user/update/profile', [UserController::class, 'update'])->name('update.profile');
Route::post('/user/address', [UserController::class, 'address'])->name('user.address');

Route::post('/user/create/new', [NewUserController::class, 'saveUser'])->name('user.create.saveUser');
...
Route::get('/admin/order/income', [AdminController::class, 'incomeChart'])->name('admin.order.income');
//print Invoice
...
Route::get('/flash-sale/showFlash', [FlashSaleController::class, 'showFlash'])->name('flashSale.showFlash');
