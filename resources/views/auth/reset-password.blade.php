...
<div class="container" style="margin-top: 100px; margin-bottom: 100px;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center text-white h3 "style=" background-image: radial-gradient(#F18B24 15%, #D45E45 100%);letter-spacing: 2px; padding: 20px 0px;">{{ __('Reset Password') }}</div>
