      ...
      <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                    ...
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="{{route('order.index')}}">
                            ...
                            <div>
                                <div class="small text-gray-500">New Order Request</div>
                                <span class="font-weight-bold">{{ $order->user->name }} send a new order request</span>
                            </div>
                        </a>
                        @endforeach

                        @foreach($newQuestion as $question)
                        <a class="dropdown-item d-flex align-items-center" href="{{route('customerQuestion.adminView')}}">
                            <div class="mr-3">
                                <div class="icon-circle bg-warning">
                                    <i class="fas fa-exclamation-triangle text-white"></i>
                                </div>
                            ...
                            <div>
                                <div class="small text-gray-500">Customer Ask New Question</div>
                                <span class="font-weight-bold">{{ $question->user->name }} ask new question</span>
                            </div>
                        </a>
                        @endforeach
    </li>
