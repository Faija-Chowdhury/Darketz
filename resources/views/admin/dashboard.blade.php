      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$monthly_price_count}}</div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$yearly_price_count}}</div>
          </div>
          <div class="col-auto">
...
<script src="{{ asset('vendors/chart.js/Chart.min.js') }}"></script>
  ...
  const url = "{{route('admin.order.income')}}";
